        ...
        <div className={styles.container}>
          <div className={styles.metadataContainer}>
            ...
            <div className={styles.descriptionContainer}>
              ...
              {const typedValue = value as { trait_type: string, value: string };return (<div className={styles.traitContainer} key={key}>
                <p className={styles.traitName}>{typedValue.trait_type}</p>
              <p className={styles.traitValue}>{typedValue.value}</p></div>);})}
              </div>
